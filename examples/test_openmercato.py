...
def test_open_mercato_customer_creation(page: Page) -> None:
    ...
    new_customer_button_xpath = "/html/body/div[2]/div[1]/div/div/main/div/div/div/div[1]/div[1]/div[2]/a"
    page.locator(f"xpath={new_customer_button_xpath}").click()

    fillin_customer_name_xpath = "/html/body/div[2]/div[1]/div/div/main/div/div/div/div[2]/form/div[1]/div[1]/div[1]/div[2]/div/div[1]/input"
    page.locator(f"xpath={fillin_customer_name_xpath}").fill("Test Customer")

    create_new_customer_xpath="/html/body/div[2]/div[1]/div/div/main/div/div/div/div[1]/div[2]/button"
    page.locator(f"xpath={create_new_customer_xpath}").click()
